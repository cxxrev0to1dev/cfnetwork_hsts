...
/* Used by the URLProtocolLoader test to verify the proxy endpoint*/
/*
 *  _CFURLProtocolGetProtocolImplInstance()
 *  
 */
CFN_EXPORT const void * 
_CFURLProtocolGetProtocolImplInstance(CFURLProtocolRef prot)  __OSX_AVAILABLE_STARTING(__MAC_10_5,__IPHONE_2_0);


/* For Foundation's use only; do not call!*/
/*
 *  _CFURLProtocolRegisterImplementationFirst()
 *  
 */
CFN_EXPORT void 
_CFURLProtocolRegisterImplementationFirst(CFURLProtocolImplementation * impl) __OSX_AVAILABLE_STARTING(__MAC_10_5,__IPHONE_2_0);


/*
 *  _CFURLProtocolBindImplementationForFoundation()
 *  
 */
CFN_EXPORT void 
_CFURLProtocolBindImplementationForFoundation(CFURLRequestRef req) __OSX_AVAILABLE_STARTING(__MAC_10_5,__IPHONE_2_0);
...
CFN_EXPORT void 
_CFURLProtocolRegisterFoundationBridge(
  CFURLProtocolImplementation *  impl,
  Boolean						preferCFURLProtocol)		 __OSX_AVAILABLE_STARTING(__MAC_10_5,__IPHONE_2_0);



/*
 *	_CFNetworkIsConnectedToInternet()
 *		exported to support [NSNetworkSettings connectionToInternet] up in Foundation
 *		Note that this is not actually avaialble in 10.5.0-10.5.3...
 */
CFN_EXPORT Boolean
_CFNetworkIsConnectedToInternet(void)						__OSX_AVAILABLE_STARTING(__MAC_10_5,__IPHONE_2_0);
