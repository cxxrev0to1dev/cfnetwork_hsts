...
WKQCA_EXPORT void WKCACFViewSetShouldInvertColors(WKCACFViewRef view, bool shouldInvertColors);
...
WKQCA_EXPORT IDirect3DDevice9* WKCACFViewGetD3DDevice9(WKCACFViewRef view);
