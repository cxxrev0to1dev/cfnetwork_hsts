...
/*
 * Currently, this is an internal testing utility only.  Please do not use it! (markp)
 *
 */
CFN_EXPORT void
_CFNetworkSetOverrideSystemProxySettings( CFDictionaryRef proxySettings ) __OSX_AVAILABLE_STARTING(__MAC_10_7,__IPHONE_4_0);
